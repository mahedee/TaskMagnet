...
/**
 * Task entity representing individual tasks in the TaskMagnet application.
 * Tasks are the core work items that can be assigned to users and organized within projects.
